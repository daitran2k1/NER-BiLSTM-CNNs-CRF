...
def download_w2v(args):
    ...
    if not os.path.exists(w2v_path):
        ...
        wget.download("https://public.vinai.io/word2vec_vi_words_100dims.zip", "wordvec/word2vec_vi_words_100dims.zip")
        # os.system("$unzip wordvec/word2vec_vi_words_100dims.zip")
        with zipfile.ZipFile("wordvec/word2vec_vi_words_100dims.zip", 'r') as zip_ref:
